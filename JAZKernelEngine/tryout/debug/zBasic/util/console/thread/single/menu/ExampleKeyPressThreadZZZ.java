...
public class ExampleKeyPressThreadZZZ<T> extends AbstractKeyPressThreadWithMenueZZZ<T> {
	private static final long serialVersionUID = 3656576563216830750L;
...
//            	}
	...
	//#########################################################################
	private void process1_(HashMapZZZ<String,Object> hm) throws ExceptionZZZ {
		//Hier noch zusätzliche Input Variablen übergebbar.
	}
	
	private void ascii_(HashMapZZZ<String,Object> hm) throws ExceptionZZZ {
		//Hier noch zusätzliche Input Variablen übergebbar.
	}
