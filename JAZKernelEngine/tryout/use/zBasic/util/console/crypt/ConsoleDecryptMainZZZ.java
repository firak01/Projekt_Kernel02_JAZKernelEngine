...
public class ConsoleDecryptMainZZZ {
	...
	public static void main(String[] args) {
		try {
			...
			IKeyPressThreadMenueableZZZ objKeyPressThread = new KeyPressThreadDecryptZZZ(objConsoleController);
...
//			this.setFileConfigKernelIni(objFileIniZZZ);
			...
			IConsoleServiceZZZ objConsoleService = new ConsoleServiceDecryptZZZ(objConsoleController);
