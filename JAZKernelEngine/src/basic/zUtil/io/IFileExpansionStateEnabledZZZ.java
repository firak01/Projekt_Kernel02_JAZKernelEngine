...
public interface IFileExpansionStateEnabledZZZ extends IFlagZEnabledZZZ{
	...
	//#############################################################
	public enum FLAGZ{
		DUMMYFLAGZ, FILE_EXPANSION_APPEND,FILE_CURRENT_FOUND; //Merke: DEBUG und INIT über IFlagZZZ eingebunden werden, weil von ObjectkZZZ kann man ja nicht erben. Es wird schon von anderer Objektklasse geerbt.
	}
