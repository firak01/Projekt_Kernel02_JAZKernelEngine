...
public interface IFileCsvReaderEnabledZZZ extends IFlagZEnabledZZZ{
	...
	//#############################################################
	public enum FLAGZ{
		DUMMYFLAGZ, IsFileSorted, IgnoreCase, IgnoreEmptyLine, IgnoreCommentLine;; //Merke: DEBUG und INIT über IFlagZZZ eingebunden werden, weil von ObjectkZZZ kann man ja nicht erben. Es wird schon von anderer Objektklasse geerbt.
	}
