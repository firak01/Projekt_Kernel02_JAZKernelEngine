...
public class FileTextSplitterZZZ_BACKUP20260731 extends  AbstractFileTextCombinedZZZ{
	private static final long serialVersionUID = 489990254115931232L;

	public FileTextSplitterZZZ_BACKUP20260731() {		
	}
	public FileTextSplitterZZZ_BACKUP20260731(String sFilePath) throws ExceptionZZZ{
		super(sFilePath);
	}
	public FileTextSplitterZZZ_BACKUP20260731(File objFile) throws ExceptionZZZ {
		super(objFile);
	}
	
	public FileTextSplitterZZZ_BACKUP20260731(List<String> listaLine) throws ExceptionZZZ {
		super(listaLine);
	}
