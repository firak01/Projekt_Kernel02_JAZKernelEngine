...
public class KeyPressUtilZZZ_BACKUP_WG_KI_CODE implements IKeyPressConstantZZZ, IConstantZZZ{
	...
	public static String computeKeyTagStringInputAlphabetCancel() {
		String sReturn = KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag("Buchstaben des Alphabets") + "/";
		sReturn = sReturn + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag(Key_cancelZZZ.getKey());	
		return sReturn;
	}
	
	public static String computeKeyTagStringInputNumericCancel() {
		String sReturn = KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag("Ganzzahlen") + "/";
		sReturn = sReturn + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag(Key_cancelZZZ.getKey());	
		return sReturn;
	}
	...
	public static String makeInputAlphabetCancel(Scanner inputReader, String sQuestionIn) throws ExceptionZZZ{
		...
		main:{
			if(inputReader==null){
				...
				ExceptionZZZ ez = new ExceptionZZZ(stemp,iERROR_PARAMETER_MISSING, KeyPressUtilZZZ_BACKUP_WG_KI_CODE.class,  ReflectCodeZZZ.getMethodCurrentName());
				throw ez;
			}
			...
			KeyPressUtilZZZ_BACKUP_WG_KI_CODE.printlnInputAlphabetCancel(sQuestion);
	...
	public static String makeInputNumericCancel(Scanner inputReader, String sQuestionIn) throws ExceptionZZZ{
		...
		main:{
			...
			KeyPressUtilZZZ_BACKUP_WG_KI_CODE.printlnInputNumericCancel(sQuestion);
	...
	public static void printlnInputAlphabetCancel(String sQuestionIn) throws ExceptionZZZ{
		...
		sQuestion = sQuestion + " " + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTagStringInputAlphabetCancel()+ "?";
	...
	public static void printlnInputNumericCancel(String sQuestionIn) throws ExceptionZZZ{
		...
		sQuestion = sQuestion + " " + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTagStringInputNumericCancel()+ "?";
		System.out.println( sQuestion);				
	}
	...
	public static String computeKeyTagStringYesNoCancel() {
		String sReturn = KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag(Key_yesZZZ.getKey()) + "/";
		sReturn = sReturn + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag(Key_noZZZ.getKey()) + "/";
		sReturn = sReturn + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag(Key_cancelZZZ.getKey());	
		return sReturn;
	}
		...
		public static String makeQuestionYesNoCancel(Scanner inputReader, String sQuestionIn) throws ExceptionZZZ{
			...
			main:{
				...
				KeyPressUtilZZZ_BACKUP_WG_KI_CODE.printlnQuestionYesNoCancel(sQuestion);
		...
		public static void printlnQuestionYesNoCancel(String sQuestionIn) throws ExceptionZZZ{
				...
				sQuestion = sQuestion + " " + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTagStringYesNoCancel()+ "?";
				System.out.println( sQuestion);				
		}
		...
		public static String makeQuestionYesNoQuit(Scanner inputReader, String sQuestionIn) throws ExceptionZZZ{
			...
			main:{
				...
				KeyPressUtilZZZ_BACKUP_WG_KI_CODE.printlnQuestionYesNoQuit(sQuestion);
		...
		public static String makeQuestionYesNoMenueQuit(Scanner inputReader, String sQuestionIn) throws ExceptionZZZ{
			...
			main:{
				...
				KeyPressUtilZZZ_BACKUP_WG_KI_CODE.printlnQuestionYesNoMenueQuit(sQuestion);
		...
		public static String makeQuestionYesNoMenueStopQuit(Scanner inputReader, String sQuestionIn) throws ExceptionZZZ{
			...
			main:{
				...
				KeyPressUtilZZZ_BACKUP_WG_KI_CODE.printlnQuestionYesNoMenueStopQuit(sQuestion);
		...
		public static String computeKeyTagStringYesNoQuit() {
			String sReturn = KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag(Key_yesZZZ.getKey()) + "/";
			sReturn = sReturn + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTagAsDefault(Key_noZZZ.getKey()) + "/";
			sReturn = sReturn + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag(Key_quitZZZ.getKey());	
			return sReturn;
		}
		...
		public static void printlnQuestionYesNoQuit(String sQuestionIn) throws ExceptionZZZ{
			...
			sQuestion = sQuestion + " " + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTagStringYesNoQuit()+ "?";
			System.out.println( sQuestion);				
	}
		...
		public static String computeKeyTagStringYesNoMenueQuit() {
			String sReturn = KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag(Key_yesZZZ.getKey()) + "/";
			sReturn = sReturn + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTagAsDefault(Key_noZZZ.getKey()) + "/";
			sReturn = sReturn + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag(Key_menueZZZ.getKey()) + "/";
			sReturn = sReturn + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag(Key_quitZZZ.getKey());	
			return sReturn;
		}
		...
		public static void printlnQuestionYesNoMenueQuit(String sQuestionIn) throws ExceptionZZZ{
			...
			sQuestion = sQuestion + " " + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTagStringYesNoMenueQuit()+ "?";
			System.out.println( sQuestion);				
	}
		...
		public static String computeKeyTagStringYesNoMenueStopQuit() {
			...
			sReturn = sReturn + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTagAsDefault(Key_noZZZ.getKey()) + "/";
			sReturn = sReturn + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag(Key_menueZZZ.getKey()) + "/";
			sReturn = sReturn + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag(Key_stopZZZ.getKey()) + "/";
			sReturn = sReturn + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTag(Key_quitZZZ.getKey());	
			return sReturn;
		}
		...
		public static void printlnQuestionYesNoMenueStopQuit(String sQuestionIn) throws ExceptionZZZ{
			...
			sQuestion = sQuestion + " " + KeyPressUtilZZZ_BACKUP_WG_KI_CODE.computeKeyTagStringYesNoMenueStopQuit()+ "?";
			System.out.println( sQuestion);				
	}
