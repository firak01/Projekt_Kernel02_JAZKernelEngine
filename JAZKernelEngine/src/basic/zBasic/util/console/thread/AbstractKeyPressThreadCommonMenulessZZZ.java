...
public abstract class AbstractKeyPressThreadCommonMenulessZZZ extends AbstractKeyPressThreadMenulessZZZ {
	public AbstractKeyPressThreadCommonMenulessZZZ() {
    	super();
    }

	public AbstractKeyPressThreadCommonMenulessZZZ(IConsoleControllerZZZ objConsole) {
    	super(objConsole);
    }
	
    public AbstractKeyPressThreadCommonMenulessZZZ(IConsoleControllerZZZ objConsole, long lSleepTime) {
